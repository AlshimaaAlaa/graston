  ...
  return (
    <div className="registerAsPatient">
            ...
            <Form>
              <div className="nameItems">
                ...
                <div className="lastName">
                  <label htmlFor="last_name" className="d-block fw-bolder mb-2 label">
                    {t("register.lastName")}
                  </label>
                  <Field
                    type="text"
      ...
      <div className="registerAsPatient__item2">
        <h5 className="text-light mb-4 fw-bolder">{t("register.notDoctor")}</h5>
        <Link to={"/RegisterAsPatient"}>
          <div className="registerAsDoctor">
            <LightBtn text={t("register.registerAsPatient")} />
          </div>
        </Link>
      </div>
    </div>
